...
class SubProcessViewModel {
  ...
  SubProcess? subprocess;
    Future<void> create(
      String name, int processId , int status , String message , int assignedto,int createdby) async {
    try {
      subprocess =
...
Future<List<SubProcess>> getByUserAndProcess(int userId, int processId) async {
